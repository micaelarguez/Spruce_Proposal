...
class searchReportPage extends BasePage {
    ...
    //WebElements
    get headerEditCreateReport(){ return $('//div[@class="sc-VigVT dTLEOK"][contains(text(),"Search Report & Title Commitment")]') }
    ...
    async validateSearchReportSection() {
        ...
        addStep(`Validate order search report dashboard`);
